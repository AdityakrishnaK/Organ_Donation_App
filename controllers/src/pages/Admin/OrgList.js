...
import "./OrgList.css"; // Add a CSS file for styling
...
const OrgList = () => {
  ...
  const handleSearch = (event) => {
    ...
    const searchResult = data.filter(
      (record) =>
        record.organisationName.toLowerCase().includes(value.toLowerCase()) ||
      ...
      <div className="org-list-container">
        ...
        {loading ? (
          ...
          <table className="org-table">
            <thead>
              <tr>
                <th onClick={() => handleSort("organisationName")}>Name</th>
